...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="#">应院宿舍管理系统</a></div>
    <div class="left_open">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;"><img src="http://up.enterdesk.com/edpic/2e/a2/82/2ea282c186df8a15b254409f04e53fc0.jpg" class="layui-nav-img">${sessionScope.ad.a_username}</a>
            <dl class="layui-nav-child"> <!-- 二级菜单 -->
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">Copyright ©2020-2020 版权所有</div>
</div>
<!-- 底部结束 -->
